...
const hostname = "https://zengsl.me"
export default hopeTheme({
    ...
    blog: {
        ...
        medias: {
            LinuxDo: {
                link: "https://linux.do/u/zzzl/",
                icon: "<svg width=\"\" height=\"\" viewBox=\"0 0 120 120\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
           ...
           /*  V2EX: {
                link: "https://www.v2ex.com/?r=zzzlll0",
...
// navbar
    ...
    markdown: {
        highlighter: {
            type: "shiki",
            // 配置项
            langs: ['ts', 'json', 'vue', 'md', 'bash', 'diff', 'java', 'javascript', 'shell', 'bash', 'markdown', 'regex', 'html', 'c', 'sql', 'xml', 'properties', 'python', 'kotlin', 'dockerfile', 'c++', 'yaml'],
        },
        // 启用 kotlin 交互演示
